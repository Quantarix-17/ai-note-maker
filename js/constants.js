...
const AT_COMMANDS = [
  ...
  { id: 'canvas', label: 'Canvas', icon: 'canvas', category: 'visual', autoParent: null,
    description: 'Increase useful visual support: tables/diagrams/concept maps/SVG illustrations (trees, people, animals, nature, etc.) where they help understanding' },
